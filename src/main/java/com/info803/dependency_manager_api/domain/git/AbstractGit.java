...
public abstract class AbstractGit {
    ...
    public <T> T executeGitAction(Depot depot, Function<Depot, T> gitAction) throws GitActionException, GitCloneException {
        try {
    ...
    */
     ...
     * @throws IllegalArgumentException
     */
    public List<File> gitCode(Depot depot) throws GitCodeException {
        String path = depot.getPath();
        if (path == null) {
     ...
     * @throws IllegalArgumentException
     */
    public String gitDelete(Depot depot) throws GitDeleteException {
        String path = depot.getPath();
        if (path == null) {
     ...
     * @throws RepositoryNotFoundException 
     */
    public String gitAdd(Depot depot, String filepattern) throws GitAddException, RepositoryNotFoundException {
        String path = depot.getPath();
        if (path == null) {
